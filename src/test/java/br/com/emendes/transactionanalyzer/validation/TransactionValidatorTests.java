...
public class TransactionValidatorTests {
  ...
  void returnFalseWhenValueIsInvalid() {
    ...
    String valueIsLessThanMin = "BANCO DO BRASIL,1234,01111-1,BANCO BRADESCO,5678,02222-2,0.009,2022-02-04T07:30:00";
    String valueIsBiggerThanMax = "BANCO DO BRASIL,1234,01111-1,BANCO BRADESCO,5678,02222-2,10000000000000.00,2022-02-04T07:30:00";
    ...
    Assertions.assertFalse(TransactionValidator.validate(valueIsLessThanMin));
    Assertions.assertFalse(TransactionValidator.validate(valueIsBiggerThanMax));
  }
  ...
  void returnFalseWhenDateTimeIsInvalid() {
    ...
    String dateTimeLessThanMin = "BANCO BANRISUL,2365,13322-9,BANCO BRADESCO,7777,01144-2,25000,1969-12-31T23:59:59";
    String dateTimeBiggerThanMax = "BANCO BANRISUL,2365,13322-9,BANCO BRADESCO,7777,01144-2,25000,2100-01-01T00:00:00";

    Assertions.assertFalse(TransactionValidator.validate(unparsedDateTime));
    Assertions.assertFalse(TransactionValidator.validate(dateTimeLessThanMin));
    Assertions.assertFalse(TransactionValidator.validate(dateTimeBiggerThanMax));
  }
